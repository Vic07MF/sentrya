...
export function TopNav() {
  ...
  return (
    <nav className="sticky top-0 z-50 flex h-14 items-center justify-between border-b border-accent/30 bg-bg-tertiary px-7">
      {/* Logo */}
      <div className="flex items-center gap-2.5">
        <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-gradient-to-br from-accent to-bg-secondary">
          <svg viewBox="0 0 16 16" className="h-4 w-4 fill-none stroke-status-safe stroke-2">
            <polyline points="1,11 5,6 8,9 11,3 15,7" />
          </svg>
        </div>
        <span className="text-lg font-extrabold tracking-[0.06em] text-brand-cream">
          SENTRYA
        </span>
      </div>
      ...
      <div className="flex items-center gap-3">
        <span className="font-mono text-[10px] text-brand-muted/50">{time}</span>
