...
class VibrationAI:
    """
    Isolation Forest para classificação em 3 níveis:
      - Normal   : leitura dentro do esperado
      - Alerta   : anomalia moderada (score 0.45–0.70)
      - Crítico  : anomalia severa  (score > 0.70)
    """
    ...
    def extract_features(self, sensor_data: Dict) -> np.ndarray:
        ...
        return np.array([vib / 100, temp, ax, ay, az, gx, gy])
